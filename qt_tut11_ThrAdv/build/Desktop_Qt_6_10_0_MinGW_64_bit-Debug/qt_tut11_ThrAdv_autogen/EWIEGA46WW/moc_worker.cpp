...
#include "../../../../../qt6-tutorial/qt_tut11_ThrAdv/worker.h"
...
void Worker::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (Worker::*)(int )>(_a, &Worker::produced, 0))
            return;
        if (QtMocHelpers::indexOfMethod<void (Worker::*)()>(_a, &Worker::finished, 1))
            return;
    }
}
